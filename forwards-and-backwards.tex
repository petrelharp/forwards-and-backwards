...
IL is supported by the ANID/Doctorado en el extranjero doctoral scholarship, grant number 2018-72190055.
TTHL supported by the EPSRC Centre for Doctoral Training in Mathematics of Random Systems: Analysis, Modelling and Simulation (EP/S023925/1) and the Deutsche Forschungsgemeinschaft (DFG, German Research Foundation) under Germany's Excellence Strategy, EXC-2047/1-390685813.
...
and using the approach of Lemma~\ref{lem:limit_mgale},
the quadratic variation of $\widehat{M}^N(f)$ satisfies
$ \IE[[\widehat{M}^N_f]_T] \le C (\theta/N) \int_0^T \IE[\langle 1, \eta_s \rangle] ds \le C' \theta/N$
