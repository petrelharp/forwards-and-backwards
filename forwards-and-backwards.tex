...
\comment{Here's an informal writeup of this convergence;
mostly I'm doing it to make sure I've got the right stuff above.}
...
\begin{align*}
    ...
    r(x, \eta) .
\end{align*}
This corresponds to births at higher levels at rate $\gamma r$.
