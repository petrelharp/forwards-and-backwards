...
\cite{birzu/hallatschek/korolev:2017, birzu/hallatschek/korolev:2021}.
...
(actually, in the prelimit,
there will be at most one individual at any point $x$),
...
$(\xi_t)_{t \ge 0}$
   is a solution to the $(A^N, \lp_0)$ martingale problem
    if 
$f(\lp_t) - f(\lp_0)-\int_0^t A^Nf(\lp_s) ds$ is a martingale (with 
