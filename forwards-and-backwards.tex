...
\begin{theorem} \label{thm:lineages}
    ...
    \begin{align}
        ...
        \left[
            ...
            + 2 \sum_j \left(
               \sum_i \partial_i (C_{ij} \log(\gamma \varphi_s))
            \right) \partial_j f
            - \sum_j \meanq_j \partial_j f
        \right] .
    \end{align}
\end{theorem}
...
\begin{align}
    ...
    &=
    g \DD^* f
    + 2 \mathcal{H} f \cdot \grad g
    + f \DD g ,
\end{align}
where $(\mathcal{H} f)_j = \sum_i \partial_i (C_{ij} f)$.
    \comment{(Need better notation for that.)}
...
\hat{\mathcal L}_s g
    ...
    \frac{r}{\varphi_s} \left[
        \gamma \varphi_s \DD g
        + 2 \mathcal{H} (\gamma \varphi_s) \cdot \grad g
        - \gamma \varphi_s \meanq \cdot \grad g
    \right] \\
    &=&
    r \gamma \left[
        \DD g
        + 2 (\mathcal{H} \log(\gamma \varphi_s)) \cdot \grad g
        - \meanq \cdot \grad g
    \right] ,
\end{eqnarray*}
...
In this section, we need only make
