...
\begin{figure}
    ...
    \caption{
        ...
        (and hence where $F=0$).
        \textb{(B)} Cartoon of interaction ($\epsilon$) and dispersal ($\sigma$) distances.
...
\cite{kolmogorov/petrovsky/piscounov:1937,\meanqramson:1983}.
...
Substituting these quantities on Equation \eqref{eq: bounds on G'} and Equation \eqref{eq: bounds on G} shows that Equation \eqref{eqn:goal3} is satisfied as long as $\epsilon_r < \epsilon_\gamma$.
\end{proof}
