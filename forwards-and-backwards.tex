...
\comment{the next theorem needs rewriting along the lines of Thm A.12 in Kurtz and Rodrigues.}
\comment{TODO: it's been rewritten some; but needs checking against that Thm yet}
...
$m^2\gamma(m)$ is bounded. We have shown that $\gamma B_f$ is bounded, and so recalling that
