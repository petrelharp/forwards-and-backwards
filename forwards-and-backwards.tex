...
of $(\lp^N_t)_{t \ge 0}$ within $(\lp^{M})_{t \ge 0}$ for $b/c < N < M$.
...
on $[0, \infty)$ such that there exist sequences $u_n \to \infty$ and $c_n$ such that
\begin{enumerate}
    \item $h_n(u) > 1$ for $u \le u_n/2$,
    \item $h_n(u) = 0$ for $u \ge u_n$,
    \item $- h_n(u) \le h_n'(u) \le 0$, and
    \item $\max\left( \int_u^\infty h_n(v) dv, \int_u^\infty h_n(v)^2 dv \right) \le c_n h_n(u)$.
\end{enumerate}
...
\comment{check: why is it closed?}
...
\begin{proof}[of Lemma~\ref{lem:compact containment lookdown}]
    ...
    by taking $C_n = 2^{n-1} K_n / \delta$ in Lemma~\ref{lem:compact containment hn}.
\end{proof}

\begin{proof}[of Lemma~\ref{lem:compact containment hn}]
    \comment{TODO: just give bounds on moments and say this follows
    ...
    \begin{align*}
    \begin{split}
        \langle h^n(u), \lp_t^N(dx, du) \rangle
        &=
        \langle h^n(u), \lp_0^N(dx, du) \rangle
        + M^{h_n}_t 
        \\ & \qquad \qquad {}
        +
        \int_0^t
    ...
    \begin{align*}
        ...
        &=
        \int_0^t
        \langle 2 a^N(x, \eta_s^N) \int_u^N h(u_1)^2 du_1
        ,
        \lp_s^N(dx, du) \big \rangle
        ds .
    \end{align*}
    Now, note that $0 \le a^N(x, \eta_x^N) \le C_a$ for some $C_a < \infty$,
    and we have assumed that $\int_u^\infty h_n(u_1) du_1 \le C_n h_n(u)$,
    so that 
    \begin{align*}
        & \int_0^t
        \big\langle
            2 a^N(x, \eta^N_s) \int_u^N h(u_1) du_1
        ,
        \lp_s^N(dx, du) \big \rangle
        ds
        \\ & \qquad
        \le
        2 C_a C_n \int_0^t \big\langle h_n(u), \lp_s^N(dx, du) \big \rangle .
    \end{align*}
    ...
    and by assumption
    $- h'(u) \le C_n h(u)$ and $h'(u) = 0$ for $u \ge u_n$,
    and so
    \begin{align*}
        & \int_0^t
        \big\langle
        ...
        ds
        \le
        C_b u_n C_n \int_0^t \big\langle h_n(u), \lp_s^N(dx, du) \big \rangle .
    \end{align*}
    Putting this together, we have that
    \begin{align} \label{eqn:hn_bound}
        \langle h^n, \lp_t^N \rangle
        &\le
        \langle h^n, \lp_0^N \rangle
        + M^{h_n}_t 
        + (2 C_a + C_b u_n) C_n \int_0^t 
            \langle h^n, \lp_s^N \rangle
        ds .
    \end{align}
    By Gronwall's inequality, with $C = (2 C_a + C_b u_n) C_n$
    \begin{align*}
        \IE\left[ \langle h^n, \lp_t^N \rangle \right]
        &\le
        \IE\left[ \langle h^n, \lp_0^N \rangle \right] e^{Ct} .
    \end{align*}

    Now consider the maximum. By \eqref{eqn:hn_bound},
    \begin{align*}
        \sup_{0 \le t \le T} \langle h^n, \lp_t^N \rangle
        &\le
        \langle h^n, \lp_0^N \rangle
        + \sup_{0 \le t \le T} M^{h_n}_t 
        + C \int_0^t 
            \sup_{0 \le t \le T} \langle h^n, \lp_s^N \rangle
        ds .
    \end{align*}
    ...
    \\ & \le
        ...
        \right] ds \right) 
    \\ & \le
        C' \left( 1 + 2 C_a C_n \int_0^t \IE\left[
        \langle h_n, \lp_s^N \big \rangle
        \right] ds \right) 
    \\ & \le 
        C' \left( 1 + C'' e^{Ct} \IE[ \langle h^n, \lp_t^N \rangle ] \right) ,
    \end{align*}
    where $C'' = 2 C_a C_n / C$.
    Therefore, 
    \begin{align*}
        \IE\left[ \sup_{0 \le t \le T} \langle h^n, \lp_t^N \rangle \right]
        &\le
        C' + \IE\left[ \langle h^n, \lp_0^N \rangle \right]( 1 + C'' e^{Ct} )
        + C \int_0^t 
            \IE\left[ \sup_{0 \le t \le T} \langle h^n, \lp_s^N \rangle \right]
        ds ,
    \end{align*}
    ...
    \begin{align*}
        \IE\left[ \sup_{0 \le t \le T} \langle h^n, \lp_t^N \rangle \right]
        &\le
        C'''(1 + \IE[\langle h^n, \lp_0^N \rangle]) e^{2Ct} ,
    \end{align*}
    and so
    \begin{align*}
        \IP\left\{ \sup_{0 \le t \le T} \langle h^n, \lp_t^N \rangle > K \right\}
        &\le
        \frac{
            C'''(1 + \IE[\langle h^n, \lp_0^N \rangle]) e^{2CT} ,
        }{ K } .
...
\begin{proof}[of Lemma \ref{lem:test_fn_tightness}]
    ...
    \begin{align*}
        ...
        &=
        \int_0^t
        \langle a^N(x, \eta_s^N) \int_u^N \int_{\IR^d}
            f(y, u_1)^2 +
            \left( f(x, u_1) + f(y, u) - f(x, u) \right)^2
        du_1 q^m(x, dy, \eta^N_s)
        \lp_s^N(dx, du) \big \rangle
        ds .
    \end{align*}
...
\subsubsection{OLD STUFF REMOVE}
