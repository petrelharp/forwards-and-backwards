...
\begin{proof}[of Lemma \ref{lem:gamma_bound}]
    ...
    \begin{align*}
        \|f'\|_\infty
            \theta \int_{\IR^d}
               \left| (\smooth{r}\eta(y) - \smooth{r}\eta(x))
               \right|
            q_\theta(x, dy)
        +
        \|f''\|_\infty
    ...
    \begin{equation}
        ...
        \theta \int_{\IR^d}
            \left|( \smooth{r} \eta(y)-\smooth{r} \eta(x) )\right|
        q_\theta(x,dy)
    ...
    Furthermore,
    applying Jensen's inequality on the function
    $\left|( \smooth{r} \eta(y)-\smooth{r} \eta(x) )\right|^2$,
    one can bound the first moment directly from estimates of the second moment.
