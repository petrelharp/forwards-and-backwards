...
\reply{
    \comment{TODO:
    Perhaps Evans/Perkins 1994 ``Measure-valued branching diffusions'' for Dawson's Girsanov thm?
    (reproduced as Thm IV.1.6 in Perkins, "Dawson-Watanabe Superprocesses...").}
    But: that is for two species.
}
...
\reply{
    ...
    we've rephased it to be more clear \revref.
}
...
\reply{
    We think this was an unedited duplicate of point 1.24 above?
}
...
\reply{
    The fact is that we can bound the expectation of the quadratic variation by a constant times the expectation of the angle bracket process;
    rather than explain again here we refer to the previous place we used the same argument
    \revref.
}
